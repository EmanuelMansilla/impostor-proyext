  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        impostor:
          "bg-gradient-to-r from-primary to-red-600 text-primary-foreground shadow-lg shadow-primary/30 hover:shadow-primary/50 animate-pulse-glow",
        safe:
          "bg-gradient-to-r from-accent to-teal-600 text-accent-foreground shadow-lg shadow-accent/30 hover:shadow-accent/50",
        game:
          "bg-gradient-to-r from-secondary to-muted text-foreground border border-border hover:border-primary/50 hover:shadow-lg",
      },
      size: {
